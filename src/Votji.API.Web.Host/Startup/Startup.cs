...
namespace Votji.API.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<APIWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app,  ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Votji API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Votji.API.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
